            ...
            <div class="col-md-5">
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <asp:DropDownList class="form-control mb-1" ID="DropDownList2" runat="server">
                    ...
                    <div class="col-md-4">
                        <label>Genre</label>
                        <div class="form-group">
                            <asp:ListBox class="form-control mb-1" ID="ListBox1" runat="server" SelectionMode="Multiple" Rows="5">
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <asp:TextBox class="form-control" ID="TextBox5" runat="server" placeholder="Book cost" TextMode="Number"></asp:TextBox>
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <label>Pages</label>
                        <div class="form-group">
                            <asp:TextBox class="form-control" ID="TextBox6" runat="server" placeholder="Pages" TextMode="Number"></asp:TextBox>
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            <asp:TextBox class="form-control" ID="TextBox8" runat="server" TextMode="Number" ReadOnly="True"></asp:TextBox>
                        </div>
                    </div>
